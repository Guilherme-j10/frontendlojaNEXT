...
const ProductPage = ({ productInfoContent }) => {
  ...
  console.log(productInfoContent);
  ...
  if(productInfoContent){
    return(
      <>
        <Head titlePage={productInfoContent.nome_produto} />
        <Header ready={logged} />
        <section className="standard_styled product_container">
          <div className="big_side_left">
            <div className="saty_image_and_info">
              ...
              <span className="productPathFile" style={{backgroundImage: `url(${url+'/'+productInfoContent.imagem_produto})`}}></span>
            </div>
            <div className="location_info_product">
              <div className="header_info_product">
                <small className="brand">{productInfoContent.marca_produto}</small>
                <h1>{productInfoContent.nome_produto}</h1>
                <div className="row_line">
                  <small>Categoria: {nameCategory}</small>
                </div>
              </div>
                <p>{productInfoContent.descricao_produto.split('').length > 100 ? `${productInfoContent.descricao_produto.substr(0, 100)}...` : productInfoContent.descricao_produto}</p>
          ...
          <div className="small_side_right">
            <div className="price_information">
              <h1>R$ {productInfoContent.valor_produto}</h1> 
        ...
        <div className="descriptionProducts">
          ...
          <p>{productInfoContent.descricao_produto}</p>
        </div>
        <div className="CommentsAboutProducts">
          ...
          {productInfoContent.comentarios.map((dados, i) => (
